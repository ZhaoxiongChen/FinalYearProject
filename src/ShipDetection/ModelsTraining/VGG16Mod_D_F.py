...
# conv1_1, relu1_1
model.add(Conv2D(filters=16, padding='same', strides=(1, 1), kernel_size=(3, 3), input_shape=(256, 256, 3),
                 activation='relu'))
# conv1_2, relu1_2
model.add(Conv2D(filters=16, padding='same', strides=(1, 1), kernel_size=(3, 3), activation='relu'))
# pool1
...
# conv2_1, relu2_1
model.add(Conv2D(filters=32, padding='same', strides=(1, 1), kernel_size=(3, 3), activation='relu'))
# conv2_2, relu2_2
model.add(Conv2D(filters=32, padding='same', strides=(1, 1), kernel_size=(3, 3), activation='relu'))
# pool2
model.add(MaxPooling2D(pool_size=(2, 2), strides=(2, 2)))
...
# fc8
# DEPRECATED: model.add(Dense(units=1, activation='softmax'))
