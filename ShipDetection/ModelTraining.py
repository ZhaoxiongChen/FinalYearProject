...
from Models import CNNProto

BATCH_SIZE = 32
EPOCHS = 20

fitted_model = CNNProto.model.fit_generator(DataPrep.prep_train,
...
CNNProto.model.save(filepath=DataPrep.DATASET_DIR + 'trained_model.h5')
CNNProto.model.save_weights(filepath=DataPrep.DATASET_DIR + 'trained_model_weights.h5')
time_end = time.time()
